...
!===========================================================================
!  fuller_LJ_npt_md_core_serial.f90
!  C60フラーレン結晶 NPT分子動力学シミュレーション
!  (LJ剛体モデル・コア版 — シングルスレッド Serial, Fortran 95)
!
!  コンパイル:
!    gfortran -O3 -o fuller_LJ_core_serial fuller_LJ_npt_md_core_serial.f90
!
!  実行:
...
contains
  ...
  double precision function calc_forces(Fv, Tv, Wm9, pos, qv, body, &
    ...
    do i = 1, N
      ...
      Wm9(1)=Wm9(1)+w00; Wm9(2)=Wm9(2)+w01; Wm9(3)=Wm9(3)+w02
      Wm9(4)=Wm9(4)+w10; Wm9(5)=Wm9(5)+w11; Wm9(6)=Wm9(6)+w12
      Wm9(7)=Wm9(7)+w20; Wm9(8)=Wm9(8)+w21; Wm9(9)=Wm9(9)+w22
      Ep = Ep + my_Ep
    end do
...
end module fuller_core_mod


! ═══════════════════════════════════════════════════════════
!  メインプログラム
! ═══════════════════════════════════════════════════════════
program fuller_LJ_core_serial
  use fuller_core_mod
  implicit none
  ...
  ! ── バナー表示 ──
  write(*,'(A)') '================================================================'
  write(*,'(A)') '  C60 LJ NPT-MD Core (Serial, Fortran 95)'
  write(*,'(A)') '================================================================'
...
end program fuller_LJ_core_serial
